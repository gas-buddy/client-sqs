...
│   ├── queue.ts            # SQSEnhancedQueue: publish/createConsumer/receive/ack
...
- **JSON-first**: `publish` serializes to JSON; `createConsumer`/`receive` auto-parse with error logging on malformed bodies
